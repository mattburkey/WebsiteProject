...
exports.validateConnection = [body('name', 'Name cannot be empty').notEmpty().trim().escape(),
...
body('start', 'Name cannot be empty').notEmpty().trim().escape(),
body('end', 'Name cannot be empty').notEmpty().trim().escape()
];
